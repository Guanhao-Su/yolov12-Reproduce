    ...
    def __call__(self, trainer=None, model=None):
        ...
        for batch_i, batch in enumerate(bar):
            ...
            with dt[1]:
                ...
                # print("这里是model输出结果：\n",
                #     "preds长度",len(preds), "\n",
                #     "preds[0].type:", type(preds[0]) ,"\n",
                #     "preds[0].shape:", preds[0].shape, "\n",
                #     "preds[1].type:", type(preds[1]), "\n",
                #     "preds[1].len:", len(preds[1]), "\n",
                #     "preds[1][0].type:", type(preds[1][0]) ,"\n",
                #     #"preds[1][0].shape:", preds[1][0].shape, "\n",
                #     "preds[1][0].len:", len(preds[1][0]), "\n",
                #     "preds[1][1].type:",type(preds[1][0]), "\n",
                #     #"preds[1][1].shape:", preds[1][1].shape, "\n",
                #     "preds[1][1].len:", len(preds[1][1]), "\n",
                #     )
            ...
            with dt[3]:
                ...
                #     "preds长度",len(preds), "\n",
                #     "preds[0].type:", type(preds[0]) ,"\n",
                #     "preds[0].keys:", preds[0].keys(),"\n",
                #     "bboxes:", preds[0]["bboxes"].shape, "\n",
                #     "conf:", preds[0]["conf"].shape, "\n",
                #     "cls", preds[0]["cls"].shape
                    # #"preds[0].shape:", preds[0].shape, "\n",
                    # "preds[1].type:", type(preds[1]), "\n",
                    # "preds[1].len:", len(preds[1]), "\n",
                    # "preds[1][0].type:", type(preds[1][0]) ,"\n",
